...
document.getElementById('open_add_custom_plant').addEventListener('click', async function() {
  ...
  document.getElementById("new_plant_type").innerHTML = asdf;
});

async function save_custom_plant(){
  let uj_fajta = document.getElementById("new_plant_type").value;
  let uj_neve = document.getElementById("new_plant_name").value;
  let uj_sortav = document.getElementById("new_plant_row").value;
  let uj_totav = document.getElementById("new_plant_col").value;
  console.log(uj_fajta, uj_neve, uj_totav, uj_sortav);
  await fetch("save",{
    method: "POST",
    headers: {
